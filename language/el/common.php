...
$lang = array_merge($lang, array(
    ...
    'NO_POST_LOG'			=> 'Αυτό το μήνυμα δεν έχει αποθηκευμένες αλλαγές στο ιστορικό. <a href="%1s">Επιστροφή στο μήνυμα</a>',
    'EDITLOG_NO_AUTH'			=> 'Δεν έχετε πρόσβαση στο ιστορικό αλλαγών αυτού του μηνύματος. <a href="%1s">Επιστροφή στο μήνυμα</a>',
    'EDITLOG_NO_DELETE_AUTH'	=> 'Δεν μπορείτε να διαγράψετε εγγραφές του ιστορικού αλλαγών. <a href="%1s">Πίσω</a>',
    'EDITLOG_DELETE_SUCCESS'	=> 'Οι εγγραφές διεγράφησαν. <a href="%1s">Πίσω</a>',
